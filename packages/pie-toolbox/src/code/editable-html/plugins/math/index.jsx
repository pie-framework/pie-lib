  ...
  serialize(object) {
    if (object.type === 'math') {
      ...
      if (MathPlugin.mathMlOptions.mmlOutput) {
        let mathMlFromLatex = renderMath(`<span data-latex="" data-raw="${decoded}">${wrapMath(decoded, wrapper)}</span>`, { skipWaitForMathRenderingLib: true });
        ...
        mathMlFromLatex = mathMlFromLatex.replace(regex, '');
